...
public struct SettingsView: View {
    ...
    public var body: some View {
        VStack(spacing: 0) {
            ...
            Form {
                Section(header: Text("İzleme ve Güncelleme").bold()) {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("PortGuard'ın arka planda portları ne sıklıkla kontrol edeceğini belirler.")
                            .font(.caption)
                ...
                Section(header: Text("RAM ve Bildirim Uyardırları").bold()) {
